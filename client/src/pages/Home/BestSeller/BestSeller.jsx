...
const BestSeller = () => {
  return (
    <>
      <div className="flex flex-1 justify-center text-center text-5xl tracking-normal font-gloock mt-10">
        <p>Best Sellers</p>
      </div>
      <div className="overflow-x-auto">
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-20 m-20 ">
